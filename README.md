...
| 09:16:12 – 09:27:07    | Adversary reconnaissance: The attacker uses the leaked access key to make repeated attempts against IAM resources, generating lots of errors. |  ![Adversary reconnaissance](<Timeline/timeline_accesskey_attempts_2.png>)|
...
| **AWS Support Email:** Leak notification with AWS Support Case ID: `5244329601` | ![AWS Support email](<IOCs/support_case_id.png>) |
...
| :--- | :--- | :--- |
| 13:57:54 | The exposed S3 bucket is set to private. | ![S3 bucket made private](<Timeline/bucket_set_private.png>) |
...
#### Lessons Learnt:
<ul>
<li> MFA is crucial - With Multi-Factor Authentication in place and properly enforced, the leaked credentials would be rendered unusable to the attackers.
...
[6] “NIST Incident response: 4-step life cycle, templates and tips,” Cynet Unified, AI-Powered Security Platform for MSPs & SMEs, https://www.cynet.com/incident-response/nist-incident-response/ (accessed Dec. 7, 2025). <br>
[7] “Incident response plan: Frameworks and steps,” CrowdStrike, https://www.crowdstrike.com/en-gb/cybersecurity-101/incident-response/incident-response-steps/ (accessed Dec. 7, 2025). <br>
[8] M. Scapicchio, A. Downie, and M. Finio, “What is a Security Operations Center (SOC)?,” IBM, https://www.ibm.com/think/topics/security-operations-center (accessed Dec. 12, 2025). <br>
[9] D. Green, “How cyber breaches are driving tighter MFA requirements,” Push Security, https://pushsecurity.com/blog/how-cyber-breaches-are-driving-tighter-mfa-requirements-and-enforcement/ (accessed Dec. 15, 2025). <br>
[10] AWS, “What is Amazon GuardDuty? - Amazon GuardDuty,” docs.aws.amazon.com, 2025. https://docs.aws.amazon.com/guardduty/latest/ug/what-is-guardduty.html (accessed Dec. 29, 2025). <br>
